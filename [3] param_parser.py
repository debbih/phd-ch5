...
def parameter_parser():
    ...
    parser.add_argument("--input-path",
                        nargs="?",
                        #default="datasetWindows/graphsA/", ###
                        default = '/scratch/Debbie_Miori/final_pools/graphsA/',
                        #default = '/scratch/Debbie_Miori/final_pools/trial',
                        #default="try-cases/", ###
                        #default="dataset-few/", ###
    ...
    parser.add_argument("--output-path",
                        nargs="?",
                        #default="to-delete/",
                        default="featuresWindows/featuresB2/", ###
